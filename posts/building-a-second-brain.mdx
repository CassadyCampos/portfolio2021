...
<blockquote class="blockquote">
  <footer class="blockquote-footer"><cite>This is why it’s so important to separate capture and organize into two distinct steps: “Keeping what resonates” in the moment is a separate decision from deciding to save something for the long term. 
  </cite></footer>
</blockquote>
<br/>
