...
<SyntaxHighlighter language="javascript">
  {`
    1. i made sure that anything we were already planning to purcahse, we already had the money for
        i.e We planned to buy a TV. we wanted the best possible TV and that was the 2021 LG OLED C1 ($3000)
    2. when we purchased it, we started a 12 month 0% interest plan 
  `}
</SyntaxHighlighter>
